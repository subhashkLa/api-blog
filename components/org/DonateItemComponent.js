...
const DonateItemComponent = (props) => {
  ...
  const handleFavLike = (favId) => {
    ...
    axios
      .post(
        `${process.env.API}/favorite-donate-item`,
        {
          fav_id: favId,
        },
        {
  ...
  const handleFavLikeDis = (favId) => {
    ...
    axios
      .post(
        `${process.env.API}/favorite-donate-item-dis`,
        {
          fav_id: favId,
        },
        {
...
export default DonateItemComponent;
